    ...
    public partial class StaffListPage : Page
    {
        ...
        private void SearchTB_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            else
            {
                try
                {
                    MainLB.ItemsSource = App.Context.Staff.Where(x => x.SurnameStaff.StartsWith(SearchTB.Text)
        ...
        private void DismissMI_Click(object sender, RoutedEventArgs e)
        {
            var staff = MainLB.SelectedValue as Staff;
            var question = MB.Quiestion($"Вы действительно хотите уволить сотрдуника " +
                $"{staff.SurnameStaff} {staff.NameStaff}?");
            if (question)
            {
                try
                {
                    ...
                    MB.Info($"Сотрдуник {staff.SurnameStaff} {staff.NameStaff} успешно уволен!");
        ...
        {
            var staff = MainLB.SelectedValue as Staff;
            var question = MB.Quiestion($"Вы действительно хотите удалить сотрдуника " +
                $"{staff.SurnameStaff} {staff.NameStaff}?");
            if (question)
            {
                try
